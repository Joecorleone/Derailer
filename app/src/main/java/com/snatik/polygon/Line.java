...
public class Line {
    ...
    private final com.snatik.polygon.Point _start;
    private final com.snatik.polygon.Point _end;
    private double _a = Double.NaN;
    private double _b = Double.NaN;
    private boolean _vertical = false;

    public Line(com.snatik.polygon.Point start, com.snatik.polygon.Point end) {
        _start = start;
        _end = end;
     ...
     */
    public boolean isInside(com.snatik.polygon.Point point) {
     ...
     */
    public com.snatik.polygon.Point getStart() {
        return _start;
    }
     ...
     */
    public com.snatik.polygon.Point getEnd() {
        return _end;
    }
