...
public class Polygon {
    ...
    private final List<com.snatik.polygon.Line> _sides;

    private Polygon(List<com.snatik.polygon.Line> sides, BoundingBox boundingBox) {
        _sides = sides;
    ...
    public static class Builder {
        private List<com.snatik.polygon.Point> _vertexes = new ArrayList<com.snatik.polygon.Point>();
        private List<com.snatik.polygon.Line> _sides = new ArrayList<com.snatik.polygon.Line>();
         ...
         * @return The builder
         */
        public Builder addVertex(com.snatik.polygon.Point point) {
            if (_isClosed) {
                // each hole we start with the new array of vertex points
                _vertexes = new ArrayList<com.snatik.polygon.Point>();
                _isClosed = false;
            }
            ...
            if (_vertexes.size() > 1) {
                com.snatik.polygon.Line Line = new com.snatik.polygon.Line(_vertexes.get(_vertexes.size() - 2), point);
                _sides.add(Line);
            }
        ...
        public Builder close() {
            ...
            // add last Line
            _sides.add(new com.snatik.polygon.Line(_vertexes.get(_vertexes.size() - 1), _vertexes.get(0)));
            _isClosed = true;
         ...
         */
        private void updateBoundingBox(com.snatik.polygon.Point point) {
            if (_firstPoint) {
     ...
     */
    public boolean contains(com.snatik.polygon.Point point) {
        if (inBoundingBox(point)) {
            com.snatik.polygon.Line ray = createRay(point);
            int intersection = 0;
            for (com.snatik.polygon.Line side : _sides) {
    ...
    public List<com.snatik.polygon.Line> getSides() {
        return _sides;
    }
     ...
     */
    private boolean intersect(com.snatik.polygon.Line ray, com.snatik.polygon.Line side) {
        com.snatik.polygon.Point intersectPoint = null;
        ...
        if (!ray.isVertical() && !side.isVertical()) {
            ...
            intersectPoint = new com.snatik.polygon.Point(x, y);
     ...
     * @return
     */
    private com.snatik.polygon.Line createRay(com.snatik.polygon.Point point) {
        // create outside point
        double epsilon = (_boundingBox.xMax - _boundingBox.xMin) / 10e6;
        com.snatik.polygon.Point outsidePoint = new com.snatik.polygon.Point(_boundingBox.xMin - epsilon, _boundingBox.yMin);

        com.snatik.polygon.Line vector = new com.snatik.polygon.Line(outsidePoint, point);
        return vector;
    }
     ...
     */
    private boolean inBoundingBox(com.snatik.polygon.Point point) {
